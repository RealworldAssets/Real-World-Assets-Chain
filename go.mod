...
require (
	...
	github.com/kpyaoqi/ics23 v0.0.0-20230928044946-a02864c656e2
)
...
replace github.com/tendermint/tendermint => github.com/kpyaoqi/tendermint v0.0.0-20230302025813-72375a6f3d4a
