...
var (
	...
	TestGenesisHash = common.HexToHash("0x0d21840abff46b96c84b2ac9e10e4f5cdaeb5693cb665db62a2f3b02d2d57b5b")
)
...
type ChainConfig struct {
	...
	PosA   *PosAConfig   `json:"PosA,omitempty" toml:",omitempty"`
}
...
// PosAConfig is the consensus engine configs for proof-of-staked-authority based sealing.
...
// String implements the stringer interface, returning the consensus engine details.
func (b *PosAConfig) String() string {
	return "PosA"
}
